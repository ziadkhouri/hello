            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul>
                        ...
                        <li>The Notification library is contained in App/Notifications
                        <li>Notifications are stored in the database
                        <li>New notification types can be added by subclassing NotificationMessage. Some examples are included.
